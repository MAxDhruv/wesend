...
const ManageUserSection = ({ handleSubsectionClick }) => {
  const [data, setData] = useState([
    { id: 1, col1: '1',  col3: 'John Doe', col4: 'john.doe@example.com', col5: '100', col6: 'Active', col7: 'Edit' },
    { id: 2, col1: '2',  col3: 'Jane Smith', col4: 'jane.smith@example.com', col5: '50', col6: 'Inactive', col7: 'Edit' },
    { id: 3, col1: '3',  col3: 'Adam Johnson', col4: 'adam.johnson@example.com', col5: '75', col6: 'Active', col7: 'Edit' },
